...
**ベータ版です。** 2026年9月12日に自動テスト1,025件、型検査、OSSビルド監査が合格しました。実際の描画・音声処理へテスト音声を流すローカル検証では、日本語50文、割り込み20回、60分連続稼働を確認しています。
...
教室、面接支援、営業チームでの利用は、機密を含まない範囲で[公開の試用相談](https://github.com/FORIFOR/AI-meeting/issues/new?template=team-pilot.yml)へ。開発初期の製品のため、運用支援や商用条件は実際の用途に応じて相談する形です。
