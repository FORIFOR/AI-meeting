...
Initial 2026-09-11 result: both variants returned HTTP 500 before any session ID or SDP answer. See [verification report](../../docs/reports/gpt-live-sdk-smoke-2026-09-11.md). After the user replenished API credit, the minimal SDK test connected, received Japanese audio and finalized successfully; a separate application playback issue was then fixed. See [post-credit recovery](../../docs/reports/gpt-live-post-credit-2026-09-11.md).
