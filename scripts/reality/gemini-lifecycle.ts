...
try {
  ...
  const report = { schemaVersion: 1, measuredAt: new Date().toISOString(), scope: "real Gemini connection lifecycle only; no voice, platform or human gate claim", status, phase, observations, rows };
