...
while True:
    ...
    if root is None:
        roots=[r[0] for r in rows if r[3].split()[0].endswith('node') and 'apps/web/scripts/soak-browser.mjs --engine google --minutes 30 --base https://ai-meeting.web.app' in r[3]]
